    ...
    public ISearchResult query(MetaQuery query) {
        ...
        try {
            ...
            if (query.getType().equals(Global.NERType.PER)){
                aq.setImageFilters(Horus.HORUS_CONFIG.getStringSetting("search_engine", "SEARCH_ENGINE_FEATURES_PER"));}
            else if (query.getType().equals(Global.NERType.ORG)){
                aq.setImageFilters(Horus.HORUS_CONFIG.getStringSetting("search_engine", "SEARCH_ENGINE_FEATURES_ORG"));}
            else {
                aq.setImageFilters(Horus.HORUS_CONFIG.getStringSetting("search_engine", "SEARCH_ENGINE_FEATURES_LOC"));}
